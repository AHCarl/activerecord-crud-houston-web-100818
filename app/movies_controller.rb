...
def can_be_found_updated_and_saved
  ...
  eaf = Movie.find_by(title: "Awesome Flick")
  Movie.update(eaf.id, title: "Even Awesomer Flick")
  eaf
end
...
def can_update_using_update_method
  ...
  wh = Movie.find_by(title: "Wat?")
  Movie.update(wh.id, title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  di = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  Movie.destroy(di.id)
end
